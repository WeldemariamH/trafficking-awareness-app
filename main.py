...
Keep it educational and protective. Structure the response with English first, followed by the Italian translation. And structure it in bullet points.
""")

def generate_lesson():
    messages = prompt.format_messages()
    response = llm.invoke(messages)
    return response.content[0][st.text]
